...
如果你想了解 **Loveit** 主题的扩展 Markdown 语法, 请阅读[扩展 Markdown 语法页面](../loveit主题文档-内容#extended-markdown-syntax).
{{< /admonition >}}
...
{{< admonition tip >}}
**LoveIt** 主题提供了一个包含更多功能的 [图片的 shortcode](../loveit主题文档-扩展-shortcodes#image).
{{< /admonition >}}
